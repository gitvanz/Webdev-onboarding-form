...
const Package = () => {
  return (
    <section className="flex flex-col gap-[50px]">
      <div>
        <h2 className="text-[36px] font-semibold px-[102px]">
          1. Select Your Package
        </h2>
        <div className="flex flex-wrap gap-[60px] mx-[103px]">
          {/* Card Essential*/}
            ...
            <div className="flex flex-col gap-[25px] border border-primary p-[16px] rounded-tl-[10px] rounded-tr-[10px]">
              ...
              <div>
                <p className="text-[20px] font-normal">
                  <span className="font-semibold">Pages: </span>Up to 3
                </p>
                <p className="text-[20px] font-normal">
                  <span className="font-semibold">Design: </span>Basic website
                  design
                </p>
                <p className="text-[20px] font-normal">
          ...
          <div className="max-w-[370px]">
            ...
            <div className="flex flex-col gap-[25px] border border-secondary p-[16px] rounded-tl-[10px] rounded-tr-[10px]">
              ...
              <div>
                <p className="text-[20px] font-normal">
                  <span className="font-semibold">Pages: </span>Up to 5
                </p>
                <p className="text-[20px] font-normal">
                  <span className="font-semibold">Design: </span>Standard,
                  professional
                </p>
                <p className="text-[20px] font-normal">
                  <span className="font-semibold">Mobile: </span>Fully
                  mobile-responsive
                </p>
              </div>
            </div>
          ...
          <div className="max-w-[370px]">
            ...
            <div className="flex flex-col gap-[25px] border border-accent p-[16px] rounded-tl-[10px] rounded-tr-[10px]">
              ...
              <div>
                <p className="text-[20px] font-normal">
                  <span className="font-semibold">Pages: </span>Up to 10
                </p>
                <p className="text-[20px] font-normal">
                  <span className="font-semibold">Design: </span>Customized
                  design tailored to your brand
                </p>
                <p className="text-[20px] font-normal">
                  <span className="font-semibold">Mobile: </span>Advanced mobile
                  responsiveness
                </p>
              </div>
            </div>
